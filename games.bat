...
set text=Bienvenue à toi es tu sur de vouloir jouer ce monde est hostile
...
set text= il était une fois une jeune femme qui se prénomais Martine Elle étais trés belle et savait parler plusieurs langues. elle étais face à son destin maintenant et ne pouvez rien faire d'autre que de se battre dans l'arène Elle allez faire face au machine et fantôme elle ne s'inquiètais pas pour l'inconu mais elle s'inquiètais plûtot pour le grand boss à battre
...
set text=Programmer par Amine Kaddar mis à jour avril 2019. Voulez vous sortir ?
...
set text=Le premier chiffre est pour le fond et le deuxième pour le texte. Entrer le Code Couleur
...
set text=The big unknown !pawn! et the big machine !pawn1! quand à the big ghost il a !pawn2! et the big boss a lui !pawn3! points
...
set text=Vous avez !money! pièces et une armure de !armor! points. Votre énergie est de !health!.
...
set text=!arme! attaque en cours attaque terminée
...
set text= énergie à !health! points
...
set text=bourse de !money! pièces
...
set pawn3=%random:~-4%
echo set speech=Wscript.CreateObject("SAPI.spVoice")>>"pawnload.vbs"
set text=The big unknown a !pawn! points et the big machine !pawn1! quand à the big ghost il a !pawn2!  et the big boss a lui !pawn3! points
echo speech.speak "%text%">>"pawnload.vbs"
start pawnload.vbs
ping localhost -n 5 > nul
del pawnload.vbs
